...
// import resumePdf from '@/images/samori_roberts_resume.pdf';
...
const ResumeCard = () => {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/samori_roberts_resume.pdf" variant="secondary" className="group mt-6 w-full">
        Open Resume
